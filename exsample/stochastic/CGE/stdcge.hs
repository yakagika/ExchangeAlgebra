...
fig_dir = "exsample/optimization/CGE/result/fig/"
csv_dir = "exsample/optimization/CGE/result/csv/"
...
event' wld t Production = do
    ...
    forM_ industries $ \e1 -> do
        ...
        -- 合成生産要素の生産
        -- 前回の生産量を取得
        lastProduction <- getTermProduction Yen wld t e1 
...
------------------------------------------------------------------
-- 価格が利潤ゼロで決まる
event' wld t PriceDetermination = do 
