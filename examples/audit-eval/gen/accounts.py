...
ACCOUNT_DIVISIONS: dict[str, str] = {
    ...
    'GiftCertificatesReceived': 'asset',
    'SecurityDepositsPaid': 'asset',
    'SuppliesOnHand': 'asset',
    'ContractAssets': 'asset',
    'IncomeTaxesRefundReceivable': 'asset',
    'WorkInProcess': 'asset',
    'DeferredTaxAssets': 'asset',
    'LeasedAssets': 'asset',
    'ToolsAndInstruments': 'asset',
    'ConstructionInProgress': 'asset',
    'Goodwill': 'asset',
    'SoftwareInProgress': 'asset',
    'LongTermPrepaidExpenses': 'asset',
    'DishonoredNotesReceivable': 'asset',
    'PrepaidPensionCost': 'asset',
    'NetDefinedBenefitAsset': 'asset',
    'DepositsInSpecialAccounts': 'asset',
    'Structures': 'asset',
    'LeaseholdRights': 'asset',
    'NonOperatingNotesReceivable': 'asset',
    'NonOperatingElectronicallyRecordedReceivable': 'asset',
    'RefundLiabilities': 'liability',
    'NonOperatingNotesPayable': 'liability',
    'NonOperatingElectronicallyRecordedObligations': 'liability',
    'BonusesPayable': 'liability',
    'AllowanceForRepairs': 'liability',
    'AllowanceForProductWarranties': 'liability',
    'AllowanceForBonuses': 'liability',
    'DeferredTaxLiabilities': 'liability',
    'LeaseObligations': 'liability',
    'GuaranteeDepositsReceived': 'liability',
    'AllowanceForRetirementBenefits': 'liability',
    'LongTermOtherPayables': 'liability',
    'NetDefinedBenefitLiability': 'liability',
    'StockSubscriptionDeposits': 'equity',
    'LegalCapitalSurplus': 'equity',
    'OtherCapitalSurplus': 'equity',
    'DividendEqualizationReserve': 'equity',
    'RepairFundReserve': 'equity',
    'ConstructionFundReserve': 'equity',
    'GeneralReserve': 'equity',
    'ValuationDifferenceOnOtherSecurities': 'equity',
    'NonControllingInterests': 'equity',
    'CapitalSurplus': 'equity',
    'EarnedSurplus': 'equity',
    'ServiceRevenue': 'revenue',
    'OperatingRevenue': 'revenue',
    'GainOnSalesOfSecurities': 'revenue',
    'GainOnValuationOfSecurities': 'revenue',
    'DividendsReceived': 'revenue',
    'InterestOnSecurities': 'revenue',
    'GainOnSalesOfInvestmentSecurities': 'revenue',
    'InsuranceGain': 'revenue',
    'GainOnBargainPurchase': 'revenue',
    'ReversalOfAllowanceForRepairs': 'revenue',
    'ReversalOfAllowanceForProductWarranties': 'revenue',
    'GainOnDonationOfFixedAssets': 'revenue',
    'GainOnNationalSubsidies': 'revenue',
    'GainOnConstructionGrants': 'revenue',
    'LandRentReceived': 'revenue',
    'SalesRebates': 'revenue',
    'CostOfServices': 'expense',
    'OperatingExpenses': 'expense',
    'InventoryShrinkageLoss': 'expense',
    'LossOnValuationOfMerchandise': 'expense',
    'Bonuses': 'expense',
    'RetirementBenefitExpenses': 'expense',
    'ProvisionForRepairs': 'expense',
    'ProvisionForBonuses': 'expense',
    'ProvisionForProductWarranties': 'expense',
    'ResearchAndDevelopmentExpenses': 'expense',
    'AmortizationOfGoodwill': 'expense',
    'AmortizationOfSoftware': 'expense',
    'AmortizationOfPatents': 'expense',
    'LeaseExpenses': 'expense',
    'IncorporationExpenses': 'expense',
    'StockIssuanceCosts': 'expense',
    'BusinessCommencementExpenses': 'expense',
    'DevelopmentExpenses': 'expense',
    'LossOnSalesOfElectronicallyRecordedReceivables': 'expense',
    'LossOnSalesOfReceivables': 'expense',
    'LossOnSalesOfSecurities': 'expense',
    'LossOnValuationOfSecurities': 'expense',
    'LossOnSalesOfInvestmentSecurities': 'expense',
    'LossOnFire': 'expense',
    'LossOnRetirementOfFixedAssets': 'expense',
    'LossOnReductionOfFixedAssets': 'expense',
    'AdditionalIncomeTaxesForPriorPeriods': 'expense',
    'RefundOfIncomeTaxes': 'expense',
    'PurchaseRebates': 'expense',
    'WelfareExpenses': 'expense',
    'MaintenanceExpenses': 'expense',
    'StatutoryWelfareExpenses': 'expense',
    'LandRentPaid': 'expense',
    'InsuranceExpense': 'expense',
    'RepairsExpense': 'expense',
    'StorageExpenses': 'expense',
    'MembershipFees': 'expense',
    'IncomeSummary': 'asset',
    'SuspenseAccount': 'asset',
    'ForeignExchangeGains': 'revenue',
    'ForeignExchangeLosses': 'expense',
    'ContraAccountForGuaranteeObligations': 'asset',
    'GuaranteeObligations': 'liability',
    'IncomeTaxesAdjustment': 'expense',
    'BranchCurrentAccount': 'asset',
    'HeadOfficeCurrentAccount': 'liability',
    'NetIncomeAttributableToNCI': 'expense',
    'NetLossAttributableToNCI': 'revenue',
    'TradingSecurities': 'asset',
    'HeldToMaturityBonds': 'asset',
