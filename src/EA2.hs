...
instance BaseClass (AccountTitles, Name, CountUnit, Day) where
    accountTitle    (a, n, u, d) = Just a
    name            (a, n, u, d) = Just n
    unit            (a, n, u, d) = Just u
    date            (a, n, u, d) = Just d
    time            _            = Nothing

instance BaseClass (AccountTitles, Name, CountUnit, Day, TimeOfDay) where
    accountTitle    (a, n, u, d, t) = Just a
    name            (a, n, u, d, t) = Just n
    unit            (a, n, u, d, t) = Just u
    date            (a, n, u, d, t) = Just d
    time            (a, n, u, d, t) = Just t
